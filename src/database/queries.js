...
global.GET_beacon_locations =
            ' \
            (SELECT d.receiver_id, i.beacon_user, d.signal_db, d.measument_time, r.location_type, r.receiver_location \
            ...
            UNION (SELECT d.receiver_id, i.beacon_user, d.signal_db, d.measument_time, r.location_type, r.receiver_location FROM beacon_detections d JOIN receiver_info r ON (d.receiver_id = r.receiver_id) JOIN beacon_info i ON (d.beacon_id = i.beacon_id) WHERE d.beacon_id = "d6:2c:ca:c0:d4:9c" ORDER BY measument_time DESC limit 3) \
            UNION (SELECT d.receiver_id, i.beacon_user, d.signal_db, d.measument_time, r.location_type, r.receiver_location FROM beacon_detections d JOIN receiver_info r ON (d.receiver_id = r.receiver_id) JOIN beacon_info i ON (d.beacon_id = i.beacon_id) WHERE d.beacon_id = "f2:36:00:21:c0:50" ORDER BY measument_time DESC limit 3) \
            UNION (SELECT d.receiver_id, i.beacon_user, d.signal_db, d.measument_time, r.location_type, r.receiver_location FROM beacon_detections d JOIN receiver_info r ON (d.receiver_id = r.receiver_id) JOIN beacon_info i ON (d.beacon_id = i.beacon_id) WHERE d.beacon_id = "e2:18:ef:c9:66:f4" ORDER BY measument_time DESC limit 3); \
            \
            ';
